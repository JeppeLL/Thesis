...
def run(dataset, data_dir, result_dir, config_id, num_gpus, total_kimg, gamma, mirror_augment, metrics):
    ...
    train.image_snapshot_ticks = train.network_snapshot_ticks = 40
    
    train.resume_pkl = '/zhome/ca/6/92701/Desktop/Master_Thesis/stylegan2/results/00008-stylegan2-records-4gpu-config-f/network-snapshot-007418.pkl'
    train.resume_kimg = 7418
